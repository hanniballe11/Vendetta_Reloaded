...
unsigned int Effect::getState(){return current_state;}
...
bool Effect::getActive(){return is_active;}
void Effect::activate(){is_active=true;}
void Effect::draw(sf::RenderTarget* sys){if(is_active && sys!=0){sys->draw(*this);}}
